 ...
 * Sorting lab uppgift 2
 * Implementering av insertionsort algoritm som ska sortera integers i stigande ordning och räkna antalet gånger ett byte sker. Algoritmens tidskomplexitet i worst case är är O(N^2).
 *
