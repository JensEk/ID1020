 ...
 * Sorting lab uppgift 5 (Del 2/2)
 * Implementering av mergesort algoritm och jämföra sorteringar av stora mängder data med insertionsort. Algoritmens tidskomplexitet i worst case är  O(Nlog(N)).
...
public class U5MergeSort {
    ...
    /* Tar emot två arrays med första och sista index platser och rekursivt kallar på sig själv tills den har brutit ner arrayen och dess index platser tills att hi och lo pekar på samma objekt och börjar då att kalla på merge. */
