/*README
 * Uppgift 2 Directed graph
 * Main program för Dfs sökning av en directed graf. Använder sig av BinarySearchST.java, Graph.java och Dfs.java klasserna. Skillnaden mot tidigare är att den kallar på en modifierad addEdge klass.
...
public class U2GraphDi {
        ...
        public static void main(String[] args) throws FileNotFoundException {
             ...
             * Andra gången så läses rad för rad av med vilka stater som har riktade förbindelser och adderas till Graph objektet med hjälp av deras indexplats.  */
            ...
            while (reader2.hasNextLine()) {
                ...
                G.addEdgeDi((graph.get(start)), graph.get(stop));
            ...
            Dfs dfs = new Dfs(G, sa);
            Iterator itr = graph.iterator();
            String nameOf = graph.min();


            /* Kollar om det finns en förbindelse mellan a och b och printar ut en väg därimellan.  */

            if (dfs.hasPathTo(sb)) {
                System.out.println(a + " till " + b + ":");

                for (int x : dfs.pathTo(sb)) {
                ...
                System.out.println("Finns ingen directed väg mellan : " + a + " - " + b);
