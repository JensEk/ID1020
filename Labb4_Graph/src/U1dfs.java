/*README
 * Uppgift 1 Dfs
 * Main program för Dfs sökning av en graf. Använder sig av BinarySearchST.java, Graph.java och Dfs.java klasserna.
...
public class U1dfs {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        * Andra gången så läses rad för rad av med vilka stater som har förbindelser och adderas till Graph objektet med hjälp av deras indexplats.  */
        ...
        /* Kollar om det finns edge mellan a och b och printar ut en väg därimellan.  */
